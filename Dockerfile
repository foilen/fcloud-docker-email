...
RUN curl https://dl.bintray.com/foilen/releases/james-server-app-3.1.0-871d10-SNAPSHOT-app.zip -o app.zip && \
...
RUN curl https://dl.bintray.com/foilen/maven/com/foilen/james-extra-components/1.2.0/james-extra-components-1.2.0.jar -o james-extra-components.jar && \
